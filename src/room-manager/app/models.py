...
class RoomModel(db.Model):
    ...
    roomCategory = db.relationShip("RoomCategoryModel", back_populates="rooms")
    establishments = db.relationShip("RoomEstablishmentModel", back_populates="room")
...
class RoomCategoryModel(db.Model):
    ...
    rooms = db.relationShip("RoomCategoryModel", back_populates="roomCategory")
...
class RoomEstablishmentModel(db.Model):
    ...
    room = db.relationShip("RoomModel", back_populates="establishments")
