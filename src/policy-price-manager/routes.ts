...
// WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
import { PolicyPriceController } from './src/controllers/PolicyPriceController';
...
const models: TsoaRoute.Models = {
    "EPolicyPrice": {
        "dataType": "refEnum",
        "enums": ["NIGHT_MAJOR_15_PERCENT", "NIGHT_MINOR_1O_PERCENT", "NIGHT_MINOR_5_PERCENT"],
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "PeriodResource": {
        "dataType": "refObject",
        "properties": {
            ...
            "sign": { "dataType": "double", "required": true },
    ...
    "PersonResource": {
        ...
        "properties": {
            "id": { "dataType": "double", "required": true },
            "nb": { "dataType": "double", "required": true },
            "percent": { "dataType": "double", "required": true },
            "sign": { "dataType": "double", "required": true },
        },
        "additionalProperties": true,
    ...
    "PolicyPriceEstablishmentResource": {
        "dataType": "refObject",
        "properties": {
            "policyPriceId": { "dataType": "double", "required": true },
            "establishmentId": { "dataType": "double", "required": true },
        },
        "additionalProperties": true,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    "PolicyPriceResource": {
        ...
        "properties": {
            "id": { "dataType": "double", "required": true },
            "key": { "ref": "EPolicyPrice", "required": true },
            "periods": { "dataType": "array", "array": { "ref": "PeriodResource" }, "required": true },
            "persons": { "dataType": "array", "array": { "ref": "PersonResource" }, "required": true },
            "establishments": { "dataType": "array", "array": { "ref": "PolicyPriceEstablishmentResource" }, "required": true },
        },
        "additionalProperties": true,
    },
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
...
export function RegisterRoutes(app: express.Express) {
    ...
    app.get('/hello',
        function(request: any, response: any, next: any) {
            ...
            const controller = new PolicyPriceController();
    ...
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/establishmment/:establishmentId',
        function(request: any, response: any, next: any) {
            const args = {
                id: { "in": "path", "name": "establishmentId", "required": true, "dataType": "double" },
            };
            ...
            const promise = controller.findByEstablishment.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.get('/:id',
        function(request: any, response: any, next: any) {
            ...
            const promise = controller.findOne.apply(controller, validatedArgs as any);
            promiseHandler(controller, promise, response, next);
        });
    // WARNING: This file was auto-generated with tsoa. Please do not modify it. Re-run tsoa to re-generate this file: https://github.com/lukeautry/tsoa
    app.delete('/:id',
    ...
    app.post('/',
        function(request: any, response: any, next: any) {
            const args = {
                policyPrice: { "in": "body", "name": "policyPrice", "required": true, "ref": "PolicyPriceResource" },
            };
